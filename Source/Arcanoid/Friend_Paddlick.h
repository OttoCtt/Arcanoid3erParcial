...
#include "Morph.h"
#include "Friend_Paddlick.generated.h"

UCLASS()
class ARCANOID_API AFriend_Paddlick : public AActor, public ISubscriber, public IMorph
{
	GENERATED_BODY()
...
public:	
	...
	UPROPERTY()
		UStaticMeshComponent* PaddlickMesh;

private:
	UPROPERTY()
		class ADementor* Dementor;
	UPROPERTY()
		class APaddle* ourpadle;
...
public:
	...
	void SetDementor(ADementor* myDementor);
