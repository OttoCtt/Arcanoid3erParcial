...
#include "Arcanoid/InventoryComponent.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	ARCANOID_API UClass* Z_Construct_UClass_UInventoryComponent();
...
// End Cross Module References
	...
	{
		P_GET_OBJECT(ACapsula,Z_Param__ActorToAdd);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(int32*)Z_Param__Result=P_THIS->AddToInventory(Z_Param__ActorToAdd);
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_UInventoryComponent_AddToInventory_Statics
	{
		...
		{
			ACapsula* _ActorToAdd;
			int32 ReturnValue;
		};
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp__ActorToAdd;
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UInventoryComponent_AddToInventory_Statics::NewProp__ActorToAdd = { "_ActorToAdd", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(InventoryComponent_eventAddToInventory_Parms, _ActorToAdd), Z_Construct_UClass_ACapsula_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UInventoryComponent_AddToInventory_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UInventoryComponent_AddToInventory_Statics::NewProp__ActorToAdd,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInventoryComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UInventoryComponent_AddToInventory, "AddToInventory" }, // 1051820830
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UInventoryComponent_Statics::NewProp_CurrentInventory_Inner = { "CurrentInventory", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_ACapsula_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UInventoryComponent, 3224369508);
	template<> ARCANOID_API UClass* StaticClass<UInventoryComponent>()
	{
		return UInventoryComponent::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UInventoryComponent(Z_Construct_UClass_UInventoryComponent, &UInventoryComponent::StaticClass, TEXT("/Script/Arcanoid"), TEXT("UInventoryComponent"), false, nullptr, nullptr, nullptr);
