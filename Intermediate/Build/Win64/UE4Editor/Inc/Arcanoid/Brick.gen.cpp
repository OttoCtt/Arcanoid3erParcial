...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ownScoreBricks_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ownScoreBricks;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABrick_Statics::NewProp_ownScoreBricks_MetaData[] = {
		{ "ModuleRelativePath", "Brick.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABrick_Statics::NewProp_ownScoreBricks = { "ownScoreBricks", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABrick, ownScoreBricks), Z_Construct_UClass_AScoreBricks_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABrick_Statics::NewProp_ownScoreBricks_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABrick_Statics::NewProp_ownScoreBricks_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABrick_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABrick_Statics::NewProp_ownScoreBricks,
	};
	...
	IMPLEMENT_CLASS(ABrick, 3523173179);
